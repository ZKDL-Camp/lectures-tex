...
\textit{plookup} allows one to use just a single one. Here is how it works.
...
consecutive elements $s_i,s_{i+1}$ with $s_i=s_{i+1}$ do not get zeroed: instead,
...
plookup) approach. Let us see how it works.
