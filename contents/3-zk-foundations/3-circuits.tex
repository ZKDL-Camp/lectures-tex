...
This is pretty loosely defined and maybe not so obvious if you do not have any background. Let us take a
look at the example.
...
\begin{definition}
    A \textbf{zk-SNARK} (Succint NARK) is a preprocessing NARK, where the
...
gates represent operations acting all elements, connected by wires (see figure
...
arithmetic circuits manipulate over elements from some finite field $\mathbb{F}$
...
\begin{example}
    Suppose our problem (as a prover) is to prove the verifier that we know the
