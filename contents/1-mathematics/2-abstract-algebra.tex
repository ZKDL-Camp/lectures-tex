...
After all, we should not care what type of set we have underneath, be it a set of elliptic curve points or simply $\mathbb{Z}_n$.
...
\begin{definition}
    ...
    we denote it by $\text{ord}(g)$. If such integer does not exist, we assume that
    $\text{ord}(g)=\infty$.
\end{definition}
...
Using the notion of isomorphism, we can restate Chinese Remainder Theorem (Thereom~\ref{th:chinese_remainder_theorem}) in the algebraic form.
\begin{theorem}[Restated Theorem~\ref{th:chinese_remainder_theorem}]
