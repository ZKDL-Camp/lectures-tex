...
\mathbb{Z}_9$ I would like to know what it means to add them. Naturally, one
...
\begin{definition}
    An \textbf{endomorphism} of a group $\mathbb{G}$ is a homomorphism $\varphi: \mathbb{G} \to \mathbb{G}$
