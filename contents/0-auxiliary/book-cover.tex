\begin{center}
    %{\Large\sffamily{Blockstream}} \\ \vspace{30mm}
    \begin{center}
        \includegraphics[width=4cm]{contents/images/common/blockstream-logo.png}\\[30mm]
    \end{center}

    \colorlet{coverBackground}{oc-blue-1}
    \colorlet{coverBoxBackground}{oc-blue-7}
    ...
    \begin{tcolorbox}[
        ...
        {\huge\bfseries ZKDL Lecture Notes} \\ \vspace{5mm}
        {Version 0.5}
    \end{tcolorbox}

    \vspace{8mm}

    {\large\bfseries Lead Author \& Editor: \\ Dmytro Zakharov and Oleksandr Kurbatov} \\[2mm]
    {\large\sffamily\color{black!70} Contributing Authors: Anton Levochko, Yevhen Hrubiian and Illia Melnyk}
