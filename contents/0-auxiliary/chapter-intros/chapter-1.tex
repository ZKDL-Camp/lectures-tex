...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{ccX}
        ...
        Automorphisms \\
        \hline
        \rowcolor{blue!10}\ref{section:polynomial-rings} & Polynomials & Divisibility, Interpolation, Schwartz-Zippel Lemma, Shamir secret sharing \\
        \hline
        \rowcolor{blue!20}\ref{section:linear-algebra} & Linear Algebra Basics & Vector and Inner Product spaces, basic operations over Vectors and Matrices \\
        \hline
        \rowcolor{blue!10}\ref{section:finite-fields} & Finite Field Extensions & Definition of $\mathbb{F}_{p^m}$, Field Multiplicative Subgroup, Algebraic Closure \\
        \Xhline{3\arrayrulewidth}
    \end{tabularx}
...
This is not a book for mathematicians, so we will not prove every mentioned theorem
...
the applied mathematics curriculums, so we will cover it in more detail.
