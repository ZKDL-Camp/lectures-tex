...
\exerciseTitle{Exercise 1.}{Which of the following statements is \textbf{false}?}
\exerciseAnswerList {
...
\exerciseTitle{Exercise 2.}{Denote $X := \{(x,y) \in \mathbb{Q}^2: xy = 1\}$. Oleksandr claims the following:}
\exerciseAnswerList {
...
\vspace{-0.5mm}
\exerciseTitle{}{Which statements are \textbf{true}?}
\exerciseMulticols{2} {
        \item Only 1.
        \item Only 1 and 2.
        \item Only 1 and 3.
...
\exerciseTitle{Exercise 3.}{Does a tuple $(\mathbb{Z},\oplus)$ with operation $a \oplus b = a + b - 1$ define a group?}
\exerciseAnswerList {
...
\exerciseTitle{Exercise 4.}{Consider the Cartesian plane $\mathbb{R}^2$, where two coordinates are real numbers. For two points $A,B$ define the operation $\oplus$}
...
\exerciseTitle{Exercise 5.}{Find the inverse of $4$ in $\mathbb{F}_{11}$.}
\exerciseMulticols{4} {
    \item 8
    \item 5
    \item 3
...
\exerciseTitle{Exercise 6.}{Suppose for three polynomials $p,q,r \in \mathbb{F}[x]$ we have $\deg p = 3, \deg q = 4, \deg r = 5$. Which of the following is true for $n := \deg \{(p-q)r\}$?}
\exerciseAnswerList {
    \item $n = 9$.
...
\exerciseTitle{Exercise 7.}{Define the polynomial over $\mathbb{F}_5$: $f(x) := 4x^2 + 7$. Which of the following is the root of $f(x)$?}
\exerciseMulticols{2} {
    \item $2$
    \item $3$
    \item $4$
...
\exerciseTitle{Exercise 8.}{Quadratic polynomial $p(x) = ax^2+bx+c \in \mathbb{R}[x]$ has zeros at $1$ and $2$ and $p(0) = 2$. Find the value of $a+b+c$.}
\exerciseMulticols{2} {
    \item $0$
    \item $-1$
    \item $1$
...
\exerciseTitle{Exercise 9.}{Which of the following is a \textbf{valid} endomorphism $f: X \to X$?}
\exerciseAnswerList {
