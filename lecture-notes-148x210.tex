...
% --- Zero-Knowledge ---
    ...
    \section[Pairing-based SNARKs]{Pairing-based SNARKs. Pinocchio and Groth16}\label{section:groth}
    \subfile{lectures/2-5-groth}

    \section{Circom}\label{section:circom}\label{section:circom}
    \subfile{lectures/2-6-circom}

    \section{PlonK}\label{section:plonk}\label{section:plonk}
