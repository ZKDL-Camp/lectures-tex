...
\section{Basics of Security Analysis}
...
\subsection{Discrete Logarithm Assumption (DL)}
...
\subsection{Deterministic prime tests}
...
\subsection{Probabilistic prime tests}
