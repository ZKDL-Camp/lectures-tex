...
\begin{example}
    ...
    \begin{center}
        \scalebox{0.9}{
        \begin{tabular}{cc}
            \centering\includegraphics[trim={100 100 100 200}, width=0.47\linewidth, clip]{images/lecture_4/line_1_view_1.pdf} &
            \centering\includegraphics[trim={100 100 100 200}, width=0.47\linewidth, clip]{images/lecture_4/line_1_view_2.pdf}
        \end{tabular}
        }
