...
Subsets of $ A \times B$ are called relations. We define a function $f \subset A
...
that $(a, b) \in f$. In other words, for every element in $A$ we assigns a
...
\subset X$. If the sequence iterates through some specific set $\mathcal{I}
...
where we introduce the very basics of linear algebra.
