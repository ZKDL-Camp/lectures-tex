...
<@\colorbox{purple!10!white}{(1 - x1) * (x2 + x3) + selectMult ==> r;}
    ...
    Let us start with the \texttt{.r1cs} file. In \Cref{section:circuits},
    ...
    \begin{lstlisting}[language=Circom,numbers=none,basicstyle=\ttfamily\scriptsize,escapechar=^]
1,1,0,^main^.r
2,2,0,^main^.x1
3,3,0,^main^.x2
4,4,0,^main^.x3
...
4,3,0,^main^.b
    ...
    \begin{lstlisting}[language=Circom,numbers=none,basicstyle=\ttfamily\scriptsize]
