...
<@\colorbox{green!10!white}{\textbf{\textcolor{blue!80!black}{signal}} x1 * x1 === x1;}@>
<@\colorbox{orange!10!white}{\textbf{\textcolor{blue!80!black}{signal}} selectMult <== x2 * x3;}@>
...
\end{center}
    ...
    And the last column is the full name of the constraint, including the path to where it is defined in the code. With this, we have covered all the important files generated by Circom.
