...
meaning that any potential input value maps to one and only one output.
...
won't be able to convince the \textit{Verifier} that the commitment was done to another value.
