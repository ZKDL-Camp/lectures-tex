    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            \item Challenger chooses a random bit $b$, commits to both messages: 
                ...
                $\mathcal{c}_1 \gets \mathsf{Commit}(pp, m_1), \mathcal{c}_2 \gets \mathsf{Commit}(pp,m_2)$, 
                    and sends $\mathcal{c}_b$ to the adversary.
        ...
        \begin{enumerate}
            \item Adversary chooses two distinct pairs $(m_1,r_1)$ and $(m_2, r_2)$ and sends to the challenger.
            \item Challenger commits to both messages: 
            
                $\mathcal{C}_1 \gets \mathsf{Commit}(pp, m_1), \mathcal{C}_2 \gets \mathsf{Commit}(pp,m_2)$, and sends $\mathcal{C}_b$ to the adversary.
            \item Adversary wins the game if $\mathcal{C}_1 = \mathcal{C}_2$.
        \end{enumerate}
