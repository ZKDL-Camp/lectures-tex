...
\begin{document}
    ...
    \begin{frame}{Neglibility}
        ...
        \begin{definition}
            \textbf{Security parameter}, denoted by $\lambda \in \mathbb{N}$, is just a parameterization of the security level, represented as a positive integer. 
        \end{definition}

        \begin{example}
            The security of the group of points on the elliptic curve is defined by the number of bits in the order of the group. So if $|\mathbb{G}|$ is $256$ bits long, then $\lambda = 256$.
        \end{example}
    \end{frame}
    ...
    \begin{frame}{Diffie-Hellman Assumption}
        \begin{definition}
    ...
    \begin{frame}{Reed-Solomon Codes}
        ...
        \begin{figure}
          \centering
          \includegraphics[width=0.5\textwidth]{images/lecture_2/reed-solomon.png}
