...
\begin{document}
    ...
    \begin{frame}{Who and When invented Plonk?}
        Ariel Gabizon, Zachary Williamson, Oana Ciobotaru introduced paper in 2019
    \end{frame}
    ...
    \begin{frame}{Arithmetization}
        Write some program (computation) into math processing-prone form.
        \begin{example}
    ...
    \begin{frame}{Encode the Program}
        ...
        \begin{enumerate}
            \item Gates (gate constraints) - using matrix $Q$.
            \item Wires (copy constraints) - using matrix $V$.
        \end{enumerate}
        \end{block}
    \end{frame}
    ...
    \begin{frame} {Gate constraints in polynomial form.}
