    ...
    \begin{frame}{Punchline}
        \begin{figure}[H]
            ...
            \begin{tikzpicture}[node distance=2.5cm, >=Stealth]
                ...
                \pause
                \draw[->, dashed, line width = 0.5mm, blue] (pq) -- (pHatqHat) node[midway, left] {$\mathcal{O}(N \log N)$};
                \draw[->, dashed, line width = 0.5mm, blue] (pHatqHat) -- (mHat) node[midway, above] {$\mathcal{O}(N)$};
                \draw[->, dashed, line width = 0.5mm, blue] (mHat) -- (m) node[midway, right] {$\mathcal{O}(N \log N)$};
