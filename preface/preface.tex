...
\textbf{Note on References.} This book currently contains only a limited number
of references explicitly cited in the text. However, before publication, we
intend to incorporate a comprehensive list of sources that have contributed to
its content. This will ensure proper acknowledgment of all relevant works and
contributors.
